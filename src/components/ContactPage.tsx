                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                      <button
                        ...
                        className={`w-full flex items-center justify-center gap-2 py-3 px-4 rounded-lg text-white font-medium transition-all ${isSubmitting
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          const msg = `Hello Trimurti Dental Clinic,%0A%0AI want to book an appointment:%0A• Name: ${encodeURIComponent(formData.name)}%0A• Phone: ${encodeURIComponent(formData.phone)}%0A• Treatment: ${encodeURIComponent(formData.treatment || 'Consultation')}%0A• Date: ${encodeURIComponent(formData.preferredDate || 'Earliest available')}%0A• Message: ${encodeURIComponent(formData.message || 'None')}`;
                          window.open(`https://wa.me/919420692977?text=${msg}`, '_blank');
                        }}
                        className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-lg text-white font-medium bg-emerald-600 hover:bg-emerald-700 transition-all shadow-md hover:shadow-lg cursor-pointer"
                      >
                    ...
                    <p className="text-xs text-gray-500 text-center">
                      Instant appointment confirmation available directly on WhatsApp or via email.
                    </p>
                  </form>
                )}
              </div>
